...
trainset = dset.ImageFolder(args.data_path, train=True, transform=train_transform) 
testset = dset.ImageFolder(args.data_path, train=False, transform=test_transform) 
...
# Below train, val, and utilties for those functions are adapted from: https://github.com/pytorch/examples/blob/master/imagenet/main.py
